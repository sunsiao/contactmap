...
path3 = r'E:\protein\rawdata\feature\testing\{dir}\foresttest_posresult.txt'
path4 = r'E:\protein\rawdata\feature\testing\{dir}\foresttest_negresult.txt'
...
for name in names:
    ...
    clf = joblib.load("foresttrain_model.m")
